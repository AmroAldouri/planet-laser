...
export const BUSINESS = {
  ...
  description:
    "Multi-level laser tag arena, arcade games, birthday parties, and corporate events in Oakville, serving families and groups across Mississauga and Burlington.",
  phone: "(905) 847-9336",
...
export const SERVICES = [
  ...
  },
  {
    ...
    description:
      "Team building missions and private bookings for groups from Mississauga, Burlington, and beyond.",
